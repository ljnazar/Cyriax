...
void Firewall::on_pushButton_toggled(bool checked)
{
    if(checked==true)
    {
        ...
        file->setFileName("../src/iptables.log.aux");
...
void Firewall::registro_log()
{
    ...
    char sys[300]="diff /var/log/iptables.log ../src/iptables.log.aux | grep '<' | sed 's/^< //g' > ../src/iptables.log.aux";
    system(sys);
...
void Firewall::registro_estado()
{
    ...
    system("../src/Conteo_estado");

    QFile *file2 = new QFile(this);
    file2->setFileName("../src/registro_estado");
...
void Firewall::registro_pkt()
{
    ...
    system("../src/Conteo_pkt");

    QFile *file3 = new QFile(this);
    file3->setFileName("../src/registro_pkt");
...
void Firewall::select_log()
{
    ...
    file1->setFileName("../src/iptables.log.aux");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes ICMP echo-request")
    {
        ...
        system("grep 'echo-request' ../src/iptables.log.aux > ../src/registro_bloqueo");

        file1->setFileName("../src/registro_bloqueo");
        file1->open(QFile::ReadOnly);
        QString strFile(file1->readAll());
        ui->plainTextEdit->appendPlainText(strFile);
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes ICMP timestamp-request")
    {
        ...
        system("grep 'timestamp-request' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes ICMP redirect")
    {
        ...
        system("grep 'redirect' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar Paquetes invalidos")
    {
        ...
        system("grep 'inválido' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes TCP SYN Erroneos")
    {
        ...
        system("grep 'Erroneo' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes de conexión entrantes TCP")
    {
        ...
        system("grep 'TCP - Conexión entrante' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes de conexión salientes TCP")
    {
        ...
        system("grep 'TCP - Conexión saliente' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes UDP entrantes")
    {
        ...
        system("grep 'UDP Entrante' ../src/iptables.log.aux > ../src/registro_bloqueo");
    ...
    if(ui->comboBox->currentText()=="Montrar paquetes UDP salientes")
    {
        ...
        system("grep 'UDP Saliente' ../src/iptables.log.aux > ../src/registro_bloqueo");
...
{
    system("cat /dev/null > ../src/iptables.log.aux");
