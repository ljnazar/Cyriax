...
void AgregarReglas::on_pushButton_clicked()
{
        ...
        { 
            if(ui->comboBox->currentText()=="Entrada")
            {
                ...
                char sys1[50];
                sprintf(sys1,"echo -n ' -i %s' >> ../src/regla_pre",cadena1);
                system(sys1);
            }
            ...
            if(ui->comboBox->currentText()=="Salida")
            {
                ...
                char sys1[50];
                sprintf(sys1,"echo -n ' -o %s' >> ../src/regla_pre",cadena1);
                system(sys1);
            }
        }
        ...
        {
            char sys2[50];
            sprintf(sys2,"echo -n ' -s %s' >> ../src/regla_pre",cadena2);
            system(sys2);
        }
        ...
        {
            char sys3[50];
            sprintf(sys3,"echo -n ' -d %s' >> ../src/regla_pre",cadena3);
            system(sys3);
        }
        ...
        {
            char sys4[50];
            sprintf(sys4,"echo -n ' -p %s' >> ../src/regla_pre",cadena4);
            system(sys4);
        }
        ...
        {
            char sys5[50];
            sprintf(sys5,"echo -n ' --sport %s' >> ../src/regla_pre",cadena5);
            system(sys5);
        }
        ...
        {
            char sys6[50];
            sprintf(sys6,"echo -n ' --dport %s' >> ../src/regla_pre",cadena6);
            system(sys6);
        }
        ...
        {
            char sys7[50];
            sprintf(sys7,"echo -n ' -m string --string \"%s\" --algo kmp' >> ../src/regla_pre",cadena7);
            system(sys7);
        }
        ...
        if(ui->timeEdit->isEnabled()==true)
        {
            ...
            {
                char sys9[50];
                sprintf(sys9,"echo -n ' -m time --timestart %s' >> ../src/regla_pre", timeaux2);
                system(sys9);
            }
        }
        ...
        if(ui->timeEdit_2->isEnabled()==true)
        {
            ...
            {
                char sys10[50];
                sprintf(sys10,"echo -n ' --timestop %s' >> ../src/regla_pre",timeaux4);
                system(sys10);
            }
