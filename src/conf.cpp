...
file1->setFileName("../src/config_resguardo");
...
void Conf::on_pushButton_clicked()
{
    ...
    if(ui->checkBox_3->isChecked()==1)
    {
        ...
        system("cat ../src/Scripts_iptables/Pqt_inv >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    if(ui->checkBox->isChecked()==1)
    {
        ...
        system("cat ../src/Scripts_iptables/ICMP_Flooding >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    if(ui->checkBox_2->isChecked()==1)
    {
        ...
        system("cat ../src/Scripts_iptables/ICMP_Redirect >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/TCP_SYN_Err >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/TCP_Flooding >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    if(ui->checkBox_6->isChecked()==1)
    {
        ...
        {
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_22 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        if((ui->checkBox_13->isChecked()==0)&(ui->checkBox_14->isChecked()==1)&(ui->checkBox_15->isChecked()==0))
        {
            ...
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_80 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        if((ui->checkBox_13->isChecked()==0)&(ui->checkBox_14->isChecked()==0)&(ui->checkBox_15->isChecked()==1))
        {
            ...
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_443 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        {
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_22_80 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        {
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_22_80_443 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        {
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_22_443 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        {
            system("cat ../src/Scripts_iptables/Conex_Ent_Except_80_443 >> ../src/config");
            system("echo '\n\n' >> ../src/config");
        ...
        if((ui->checkBox_13->isChecked()==0)&(ui->checkBox_14->isChecked()==0)&(ui->checkBox_15->isChecked()==0))
        {
            ...
            system("cat ../src/Scripts_iptables/Conex_Ent >> ../src/config");
            system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/Conex_Sal >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/TCP_flags_inv >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/UDP_Flooding >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/UDP_Ent >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/UDP_Sal >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    {
        system("cat ../src/Scripts_iptables/SSH_Brute_Force >> ../src/config");
        system("echo '\n\n' >> ../src/config");
    ...
    file2->setFileName("../src/config_resguardo");
