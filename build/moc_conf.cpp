...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Conf_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 97, 7)
    ...
    "Conf\0loadwindows\0\0on_pushButton_clicked\0"
    "on_pushButton_2_clicked\0closeEvent\0"
    "on_checkBox_6_toggled\0checked"
};
...
void Conf::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Conf *_t = static_cast<Conf *>(_o);
        switch (_id) {
        case 0: _t->loadwindows(); break;
        case 1: _t->on_pushButton_clicked(); break;
        case 2: _t->on_pushButton_2_clicked(); break;
        case 3: _t->closeEvent(); break;
        case 4: _t->on_checkBox_6_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject Conf::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Conf.data,
      qt_meta_data_Conf,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Conf.stringdata))
        return static_cast<void*>(const_cast< Conf*>(this));
